...
public class ChannelListAdpter extends ArrayListAdapter<DtvProgram> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.epg_minify_channel_list_item, null);
		...
		/**
		 * change By YangLiu 2014-12-17 解决当快速在频道列表中按上下键时，再按右键到节目列表，焦点回到节目列表，但是没有突出显示，反而显示在频道列表
		 */
		//设置频道焦点变换的效果
